using ERP.Application.Doctors.GetAllDoctors.GetAllDoctorQuery;
using ERP.Application.Features.Roles.GetAllRoles;
using ERP.Domain.Users;
using ERPServer.Application.Features.Patients.GetAllPatients;
